...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{n}{runClassifier}\PY{o}{.}\PY{n}{trainTestSet}\PY{p}{(}\PY{n}{perceptron}\PY{o}{.}\PY{n}{Perceptron}\PY{p}{(}\PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{numEpoch}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+m+mi}{1}\PY{p}{\PYZcb{}}\PY{p}{)}\PY{p}{,} \PY{n}{datasets}\PY{o}{.}\PY{n}{TennisData}\PY{p}{)}
\end{Verbatim}
...
Training accuracy 0.6428571428571429, Test accuracy 0.6666666666666666
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{n}{runClassifier}\PY{o}{.}\PY{n}{trainTestSet}\PY{p}{(}\PY{n}{perceptron}\PY{o}{.}\PY{n}{Perceptron}\PY{p}{(}\PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{numEpoch}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+m+mi}{2}\PY{p}{\PYZcb{}}\PY{p}{)}\PY{p}{,} \PY{n}{datasets}\PY{o}{.}\PY{n}{TennisData}\PY{p}{)}
\end{Verbatim}
...
Samples}\label{permuting-training-samples}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{n}{runClassifier}\PY{o}{.}\PY{n}{trainTestSet}\PY{p}{(}\PY{n}{perceptron}\PY{o}{.}\PY{n}{PermutedPerceptron}\PY{p}{(}\PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{numEpoch}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+m+mi}{1}\PY{p}{\PYZcb{}}\PY{p}{)}\PY{p}{,} \PY{n}{datasets}\PY{o}{.}\PY{n}{TennisData}\PY{p}{)}
\end{Verbatim}
...
Training accuracy 0.7857142857142857, Test accuracy 0.8333333333333334
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{n}{runClassifier}\PY{o}{.}\PY{n}{trainTestSet}\PY{p}{(}\PY{n}{perceptron}\PY{o}{.}\PY{n}{PermutedPerceptron}\PY{p}{(}\PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{numEpoch}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+m+mi}{1}\PY{p}{\PYZcb{}}\PY{p}{)}\PY{p}{,} \PY{n}{datasets}\PY{o}{.}\PY{n}{TennisData}\PY{p}{)}
\end{Verbatim}
...
Training accuracy 0.6428571428571429, Test accuracy 0.5
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{runClassifier}\PY{o}{.}\PY{n}{trainTestSet}\PY{p}{(}\PY{n}{perceptron}\PY{o}{.}\PY{n}{PermutedPerceptron}\PY{p}{(}\PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{numEpoch}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+m+mi}{1}\PY{p}{\PYZcb{}}\PY{p}{)}\PY{p}{,} \PY{n}{datasets}\PY{o}{.}\PY{n}{TennisData}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}8}]:} \PY{k}{def} \PY{n+nf}{plotCurve2}\PY{p}{(}\PY{n}{titleString}\PY{p}{,} \PY{n}{data1}\PY{p}{,} \PY{n}{data2}\PY{p}{)}\PY{p}{:}
            ...
            \PY{c+c1}{\PYZsh{}xlabel(\PYZsq{}\PYZsh{} of training points\PYZsq{})}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{n}{plotCurve2}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Mean train and test accuracy}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{data1}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}\PY{p}{,} \PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{data2}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
